...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    /// Reuse identifier `MediaListCell`.
    static let mediaListCell: Rswift.ReuseIdentifier<MediaListCell> = Rswift.ReuseIdentifier(identifier: "MediaListCell")
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let mediaDetailsVC = StoryboardViewControllerResource<MediaDetailsVC>(identifier: "MediaDetailsVC")
      let name = "Main"

      func mediaDetailsVC(_: Void = ()) -> MediaDetailsVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: mediaDetailsVC)
      }

      static func validate() throws {
        if #available(iOS 11.0, tvOS 11.0, *) {
          if UIKit.UIColor(named: "BlackColor", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'BlackColor' is used in storyboard 'Main', but couldn't be loaded.") }
        }
        if _R.storyboard.main().mediaDetailsVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'mediaDetailsVC' could not be loaded from storyboard 'Main' as 'MediaDetailsVC'.") }
      }
